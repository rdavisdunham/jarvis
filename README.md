...
- **Text-to-Speech** - AI responses are spoken aloud using Groq Orpheus (low-latency, expressive voices with emotion annotations)
...
When using TTS, you can include emotion annotations in the AI's responses. These are automatically hidden from the displayed text but affect the voice output:
