"""Exercise task tabs, drag input and calendar details in a disposable database with synthetic credentials."""
...
def main():
    ...
    name = "jarvis_calendar_tasks_test_" + uuid4().hex
        ...
        with tempfile.TemporaryFile() as log:
            server = subprocess.Popen(
                [
                    ...
                    "--app-dir", str(ROOT / "tests" / "fixtures"),
                    "--host",
                    "127.0.0.1",
                    "--port",
                    str(port),
