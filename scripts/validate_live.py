"""Opt-in real GPT-Live browser test in a disposable database; generated audio only."""
...
def main():
    ...
    name = "jarvis_live_test_" + uuid4().hex
    ...
    try:
        ...
        os.environ.update(
            ...
            JARVIS_OWNER_TOKEN="live-fixture",
            JARVIS_ORIGIN=base,
        ...
        with tempfile.TemporaryFile() as log:
            ...
            subprocess.run(
                ["node", "e2e/live-only.mjs"],
                cwd=ROOT / "apps" / "web",
                env={**os.environ, "JARVIS_LIVE_TEST_URL": base, "JARVIS_LIVE_TEST_TOKEN": "live-fixture"},
                check=True,
            )
    finally:
        if server:
